...
from openrlhf.datasets import mtSFTDataset
from openrlhf.models import Actor
from openrlhf.trainer import mtSFTTrainer
from openrlhf.utils import blending_datasets, get_strategy, get_tokenizer
from openrlhf.gameenv.chatutils import get_special_ids, freeze_except_embed_and_lm_head
...
def train(args):
    ...
    train_data = blending_datasets(
        ...
        return_eval=False,    # 这句话可以不生成测试集
        # eval_split=args.eval_split,
    )
    train_data = train_data.select(range(min(args.max_samples, len(train_data))))
    train_dataset = mtSFTDataset(
        train_data,
        tokenizer,
        args.max_len,
        strategy,
...
if __name__ == "__main__":
    ...
    # parser.add_argument('--master-port', type=int, default=29510, help='Port used for distributed training')
    
    parser.add_argument("--master_port", type=int, default=None, help="Port for distributed training")
